...
func _ready() -> void:
	...
	var sky_texture := Util.load_texture(HWTheme.get_theme_path().plus_file("Sky.png"))
	if sky_texture:
	...
	var horizont_texture := Util.load_texture(HWTheme.get_theme_path().plus_file("horizont.png"))
	var horizont_textureL := Util.load_texture(HWTheme.get_theme_path().plus_file("horizontL.png"))
	var horizont_textureR := Util.load_texture(HWTheme.get_theme_path().plus_file("horizontR.png"))
	if horizont_texture:
	...
	var cloud_texture := Util.load_texture(HWTheme.get_theme_path().plus_file("Clouds.png"))
	if cloud_texture:
	...
	var water_texture := Util.load_texture(HWTheme.get_theme_path().plus_file("BlueWater.png"))
	if not water_texture:
		water_texture = Util.load_texture(Util.hedgewars_path.plus_file("Graphics/BlueWater.png"))
