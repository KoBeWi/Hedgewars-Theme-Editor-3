...
func _ready() -> void:
	...
	var sky_texture := Utils.load_texture(HWTheme.get_theme_path().plus_file("Sky.png"))
	if sky_texture:
	...
	var horizont_texture := Utils.load_texture(HWTheme.get_theme_path().plus_file("horizont.png"))
	var horizont_textureL := Utils.load_texture(HWTheme.get_theme_path().plus_file("horizontL.png"))
	var horizont_textureR := Utils.load_texture(HWTheme.get_theme_path().plus_file("horizontR.png"))
	if horizont_texture:
	...
	var cloud_texture := Utils.load_texture(HWTheme.get_theme_path().plus_file("Clouds.png"))
	if cloud_texture:
	...
	var water_texture := Utils.load_texture(HWTheme.get_theme_path().plus_file("BlueWater.png"))
	if not water_texture:
		water_texture = Utils.load_texture(Utils.hedgewars_path.plus_file("Graphics/BlueWater.png"))
